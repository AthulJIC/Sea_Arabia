...
import { View, Text, SafeAreaView, Pressable, ScrollView, TouchableOpacity } from "react-native";
    ...
    return (
        <SafeAreaView style={{ flex: 1, backgroundColor: 'white' }}>
            <ScrollView>
                ...
                <View style={{ width: '90%', alignSelf: 'center', marginTop: 30, backgroundColor: 'white', borderRadius: 6, elevation: 3, justifyContent: 'center', shadowColor: '#000', shadowOffset: { width: 0, height: 2 }, shadowOpacity: 0.25, shadowRadius: 3 }}>
                    {data.map((item, index) => (
                        <View key={index} style={{ top: 15 }}>
                            <Pressable
                                style={{ height: 50, marginLeft: 20, flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between', marginBottom: 10 }}
